...
nextButton.innerHTML = 'Click me ❤️';

// Apply CSS styles to position the button at the bottom
nextButton.style.position = 'fixed';
nextButton.style.bottom = '190px';
...
// Define a function for what happens when the button is clicked (replace 'nextPage.html' with your actual next page URL)
nextButton.onclick = function() {
    window.location.href = 'https://flowerglass.netlify.app/'; // Redirect to the next page
};
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = 'Oh no! You\'re sure?';
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'You really sure, huh?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = 'Are you positive?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Say yes please?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Yes, you say I won\'t be very sad';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'I will be very sad';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'I will be very very very very sad.';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Ok, I\'ll stop asking...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'I will be very very very very very sad.';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 13:
            ...
            document.getElementById('noBtn').innerHTML = 'Yes, you say I won\'t be very very very very sad :(';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'NO... I already said yes';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = 'You Siiiiiiiiiiiiiiiiiiiiiiiiiiii';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
